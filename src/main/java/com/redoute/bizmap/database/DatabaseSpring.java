package com.redoute.bizmap.database;
...
public class DatabaseSpring implements Database {
    ...
    public Connection connect() {
        try {
            ...
            Logger.log(DatabaseSpring.class.getName(), Level.ERROR, "Cannot connect to datasource jdbc/bizmap : " + exception.toString());
        }
    ...
    public List<List<String>> getDataForGraph(String script) {
        ...
        Logger.log(DatabaseSpring.class.getName(), Level.INFO, "connecting to jdbc/bizmap from databaseSpring");
